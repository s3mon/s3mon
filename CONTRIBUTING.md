# Contributing to s3mon

First and foremost, thank you! We appreciate that you want to contribute to
**s3mon**, your time is valuable, and your contributions mean a lot to us.
...
- star :star: the [project](https://github.com/s3mon/s3mon)
- tweet your support for **s3mon**
...
- **version**: please note the version of **s3mon** are you using
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using
- **error messages**: please paste any error messages into the issue, or a [gist](https://gist.github.com/)

### Closing issues

The original poster or the maintainer's of **s3mon** may close an issue at
...
[so]: http://stackoverflow.com/questions/tagged/s3mon
